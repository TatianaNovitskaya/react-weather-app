    ...
    return (
        <div className="App">
            <div className="container">
                <div className="row weather-app-header justify-content-between">
                    ...
                    <form className="col-12 col-lg-5 search ">
                        <div className="col-2 col-lg-2 current-position">
                            <p>Current city</p>
                        </div>
                        <input
                            type="text"
                            className="col-10 col-lg-10 input-search"
                ...
                <div className="row weather-app-main ">
                    ...
                    <div className="col-3 weather-temp">
                        <p className="show-temperature">°</p>
